...
- **Task Reminder Emails:** Edge function `task-reminders` sends automated deadline emails to team members. Two modes:
  ...
  - pg_cron jobs: `task-reminders-upcoming` and `task-reminders-pastdue`, both visible on Manage > Scheduled Jobs page
